// gcc -o fac -I/opt/local/lib/erlang/lib/erl_interface-3.5.7/include -L/opt/local/lib/erlang/lib/erl_interface-3.5.7/lib fac.c -lerl_interface -lei
...
int main(int argc, char **argv) {
 ...
 ETERM *fromp, *argp, *resp;   /* Representations of Erlang terms */
 ...
 if (erl_connect_init(1, "mycookie", 0) == -1)
   erl_err_quit("erl_connect_init");

   /* connect to a running Erlang node     */
 if ((fd = erl_connect("blah@computerone")) < 0)
